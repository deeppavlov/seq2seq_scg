...
from .misc import read_corpus, batch_slice, data_iter, to_input_variable
...
class BatchGenerator:
    ...
    def data_generator(self, train_batch_size=64, eval_batch_size=64, test_batch_size=64):
        return self.train_data_generator(train_batch_size), self.eval_data_generator(eval_batch_size), self.test_data_generator(test_batch_size)

    def __init__(self, vocab_path, train_batch_size=64, eval_batch_size=64, test_batch_size=64):
        self.vocab = torch.load(vocab_path)
        self.data_gen_train, self.data_gen_eval, self.data_gen_test = self.data_generator(train_batch_size, eval_batch_size, test_batch_size)
